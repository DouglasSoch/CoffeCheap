...
public class Venta_factura {
    ...
    /**
     * Contructor para String
     *
     * @param temp_fecha_emision String
     */
    ...
    /**
     * Contructor para boolean
     *
     * @param opc_propina boolean
     */
    ...
    /**
     * Constructor para timestamp
     *
     * @param fecha_emision fecha
     */
     ...
     *
     * @param temp_fecha_emision atributo
     * @param opc_propina atributo
     * @param tem_total atributo
     * @param id_venta_factura atributo
     * @param nit_empresa atributo
     * @param subtotal atributo
     * @param iva atributo
     * @param propina atributo
     * @param total atributo
     * @param pedido atributo
     * @param cliente atributo
     * @param fecha_emision atributo
     */
