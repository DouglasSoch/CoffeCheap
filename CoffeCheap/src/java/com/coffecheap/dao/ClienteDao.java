...

{
    public void registrar(Cliente cli) throws Exception
    {
        ...
        {   
            ...
            PreparedStatement st = this.getCn().prepareStatement("insert into cliente values(?,?,?)");
      ...
      public List<Cliente > mostrar() throws Exception
    {
        ...
        {
            this.conectar();
            PreparedStatement st = getCn().prepareCall("select id_cliente, nombre_cliente, direccion from cliente");
            rs=st.executeQuery();
            lista = new ArrayList();
      ...
      public List<Cliente> mostrarPorPrarametro(Transaccion_inventario  traInv) throws Exception
    {
        ...
        {
            this.conectar();
            PreparedStatement st = getCn().prepareCall("select id_cliente, nombre_cliente, direccion from cliente where id_cliente=?");
