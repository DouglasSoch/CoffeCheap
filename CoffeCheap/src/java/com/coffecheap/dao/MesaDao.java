...
public class MesaDao extends Dao {
  ...
  public void modificar(Mesa tt) throws Exception {
    ...
    try {
      this.Conectar();
      PreparedStatement st = this.getCon().prepareStatement("UPDATE  mesa SET id_Mesa=?, cantidad_Comensales=?, Ubicacion=?, id_reserva=?, id_cliente=? WHERE id_Mesa=?;");
