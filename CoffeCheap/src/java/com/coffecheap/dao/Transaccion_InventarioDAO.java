...
public class Transaccion_InventarioDAO extends Dao {
    ...
    public List<Transaccion_inventario> mostrar() throws Exception {
        ...
        try {
            ...
            PreparedStatement st = getCon().prepareCall("select traInv.id_transaccion, traInv.fecha, "
                    ...
                    + "tipTran.id_tipo_transacciones) order by traInv.id_transaccion");
            rs = st.executeQuery();
            lista = new ArrayList();
    ...
    public List<Transaccion_inventario> listarParaProducto() throws Exception {
        List<Transaccion_inventario> lista;
        ResultSet rs;
        try {
            this.Conectar();
            ...
            while (rs.next()) {
                ...
                traInv.getProducto().setId_producto(rs.getInt("id_producto"));
                traInv.getProducto().setNombre(rs.getString("nombre_producto"));
                lista.add(traInv);
            }
        } catch (Exception e) {
            throw e;
    ...
    public List<Transaccion_inventario> listarParaTtransaccion() throws Exception {
        List<Transaccion_inventario> lista;
        ResultSet rs;
        try {
            this.Conectar();
